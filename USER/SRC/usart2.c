...
void USART2_Configuration()
{
	...
	DMA_InitStructure.DMA_Memory0BaseAddr =(uint32_t)(USART.TxBuffer_UASRT2);
				...
				switch(USART2_RX_BUF[3])
				{
					...
					case 0x01:      //页面id
					{
						switch(USART2_RX_BUF[5])
						{
							case 24://复位陀螺仪
							{					            
								gyroscopes_whu(FALSE);
								break;
							}      
							case 15://失能
							{					            
								FlagPara.Mode_Run = DISABLE;	
								Elmo_Enable(0,FALSE,DISABLE);
								break;
							}           
							case 16://失能
							{
							...
							case 7://x坐标
							{					            
								MovePara.x_want=(atof((char*)(&USART2_RX_BUF[7])));
								break;
							}  
							case 8://y坐标
							{					            
								MovePara.y_want=(atof((char*)(&USART2_RX_BUF[7])));
								break;
							}  
							case 9://角度
							{					            
								MovePara.angle_want=(atof((char*)(&USART2_RX_BUF[7])));
								break;
							}  
							case 11://速度
							{					            
								MovePara.v_want=(atof((char*)(&USART2_RX_BUF[7])));
								break;
							}  
							case 23://运动时间
							{					            
								MovePara.time=(atof((char*)(&USART2_RX_BUF[7])));
								break;
							}  
							case 22://x+
							{
								FlagPara.Mode_Run = ENABLE;	
								MovePara.direction_flag=1;
								break;
							}  
							case 19://y+
							{
								FlagPara.Mode_Run = ENABLE;			
								MovePara.direction_flag=2;
								break;
							}  
							case 20://x-
							{
								FlagPara.Mode_Run = ENABLE;
								MovePara.direction_flag=3;
								break;
							}  
							case 21://y-
							{
								FlagPara.Mode_Run = ENABLE;				
								MovePara.direction_flag=4;
								break;
							}  
